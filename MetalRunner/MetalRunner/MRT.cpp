...
namespace Ks {
    ...
    bool MultiRenderTargetinitialize(void* _wnd, Ks::ArchieveProtocol* _archieve) {
        m_resInited = false;
    ...
    void MultiRenderTargetinitializeResources() {
        //
    ...
    void MultiRenderTargetresize(uint32_t _width, uint32_t _height) {
        m_size.width = _width;
    ...
    void MultiRenderTargetrelease() {
    }
    
    void MultiRenderTargettick() {
        Ks::RpClear clear;
